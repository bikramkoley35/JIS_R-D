    ...
    <style>
        ...
        * {
        ...
        .jis-global-engagement-hero {
            background: url('https://www.jisuniversity.ac.in/images/gallery/DSC_1252.jpg') center/cover;
            height: 90vh;
            display: flex;
            align-items: center;
...
<body>
    <!-- HEADER & NAVIGATION -->
    <?php include 'public_html/assets/phppages/headernav.php'; ?>
    ...
    <!-- FOOTER -->
    <?php include 'public_html/assets/phppages/footer.php'; ?>
